...
class Account_settingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (BuildContext context) => Account_settingCubit(),
        child: Scaffold(
            body: Padding(
...
SizedBox(height: 11,),
              Row(
                ...
                children: [
                  SvgPicture.asset("assets/images/Google.svg",height: 30,width: 30,),SizedBox(width: 7,),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Google",style: TextStyle(fontSize: 13,color: AppStyle.blackColor,
                        fontWeight: FontWeight.bold,),),
                      Text("Connected",style: TextStyle(fontSize: 13,color: Color(0xff20CA38),
                        fontWeight: FontWeight.bold,),),
              ...
              CustomButton(title: "Change Password".tr(), function: (){
                Utils.showBottonSheetChangePaaword(context);

              },bgColor: Colors.white,textColor: AppStyle.primaryColor,),
              SizedBox(height: 11,),
              CustomButton(title: "Save Changes".tr(), function: (){},bgColor: AppStyle.primaryColor,
