...
abstract class Utils {
  ...
  static void resetPassword2(context) async {
    showDialog(context: context, builder: (context) {
      return AlertDialog(
        content: PopupCardDetails(
  ...
  static void verifyAccount2(context) async {
    showDialog(context: context, builder: (context) {
      return AlertDialog(
          content:
          PopupCardDetails3(
            text1: "Your account has been successfully activated! You will now be automatically redirected to the homepage.".tr(),
            text2: "Congratulations".tr(),
            text1Color: AppStyle.lightBlackColor,
            text2Color: AppStyle.primaryColor,
            fontWeight: FontWeight.bold,
  ...
  static void completeOrder(context) async {
    showDialog(context: context, builder: (context) {
      return AlertDialog(
          content:
          PopupCardDetails3(
            text1: "Your order has been successfully placed and is now in review.".tr(),
