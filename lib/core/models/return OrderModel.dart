...
ReturnOrderModel({this.data, this.links, this.meta});
...
Items({this.id, this.orderId, this.grandTotal, this.subTotal, this.returnDate, this.orderDate, this.discount, this.address, this.status, this.statusKey, this.name, this.currency});
